                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            ...
                            document.querySelector('.navbar-logo').setAttribute('src', 'https://designreset.com/cork/html/src/assets/img/logo.svg')
                            // document.querySelector('.navbar-logo').setAttribute('assets/src', getUpdatedParseObject.settings.layout.logo.lightLogo)
                        }
                    }
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            ...
                            // https://designreset.com/cork/html/src/assets/img/logo.svg
